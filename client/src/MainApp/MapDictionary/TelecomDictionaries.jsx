...
export const regionsToProvincesMap = {
  ...
  "REGION XI (DAVAO REGION)": [
    "DAVAO DEL NORTE", "DAVNOR", "DDN",
    "DAVAO DEL SUR", "DAVSUR", "DDS",
    "DAVAO ORIENTAL", "DAVOR", "DVO ORIENTAL",
    "DAVAO DE ORO", "DDO",
    "COMPOSTELA VALLEY", "COMVAL", "CVLY",
    "DAVAO OCCIDENTAL", "DVOC",
    "DAVAO", "DVO"
  ],
  
  // --- NORTHERN MINDANAO ---
  "REGION X (NORTHERN MINDANAO)": [
    "MISAMIS ORIENTAL", "MISOR", "MOR",
    "MISAMIS OCCIDENTAL", "MISOCC", "MOCC",
    "LANAO DEL NORTE", "LDN",
    "BUKIDNON", "BUK",
    "CAMIGUIN", "CMGN"
  ],
  ...
  "REGION XII (SOCCSKSARGEN)": [
    "SOUTH COTABATO", "SCOT", "SCO",
    "COTABATO", "NORTH COTABATO", "NCOT", "NCO",
    "SULTAN KUDARAT", "SKUD",
    "SARANGANI", "SAR"
  ],
  ...
  "REGION XIII (CARAGA REGION)": [
    ...
    "SURIGAO DEL SUR", "SDS",
    "DINAGAT ISLANDS", "DNGT"
  ],
  
  // --- ZAMBOANGA PENINSULA ---
  "REGION IX (ZAMBOANGA PENINSULA)": [
    "ZAMBOANGA DEL SUR", "ZDS",
    "ZAMBOANGA DEL NORTE", "ZDN",
    "ZAMBOANGA SIBUGAY", "ZSG",
    "ZAMBOANGA", 
    "SULU"          
  ],
